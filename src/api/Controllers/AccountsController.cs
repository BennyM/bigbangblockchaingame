...
namespace api.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Post([FromBody]InitAccountRequest initRequest)
        {
            ...
            var encoded = web3.OfflineTransactionSigner.SignTransaction(_account.Value.MasterAccountPrivateKey, initRequest.Address, new BigInteger(100000000000000000000) , txCount.Value);
